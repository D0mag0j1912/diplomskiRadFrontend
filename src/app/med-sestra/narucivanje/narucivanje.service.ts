...
export class NarucivanjeService{
    ...
    getDatumiNazivi(){
        ...
        return this.http.get<any>(this.baseUrl + 'narucivanje/getDatumiNazivi.php').pipe(catchError(handleError));
    }

    //Metoda koja vraća Observable u kojemu se nalaze sva vremena u danu
    getVremena(){

        return this.http.get<any>(this.baseUrl + 'narucivanje/getVremena.php').pipe(catchError(handleError));
    }
    ...
    getNarudzba(idNarudzba: string){
        ...
        return this.http.get<any>(this.baseUrl + 'narucivanje/getNarudzba.php',{params: params}).pipe(catchError(handleError));
    }

    //Metoda koja vraća Observable u kojemu se nalaze svi pacijenti (IME I PREZIME)
    getPacijenti(){

        return this.http.get<any[]>(this.baseUrl + 'narucivanje/getPacijenti.php').pipe(catchError(handleError));
    }

    //Metoda koja vraća Observable u kojemu se nalaze sve vrste pregleda i ostali podatci vezani za pacijenta i narudžbu
    getVrstaPregled(){

        return this.http.get<any[]>(this.baseUrl + 'narucivanje/getVrstaPregled.php').pipe(catchError(handleError));
    }

    //Metoda koja vraća Observable u kojemu se nalaze sve RAZLIČITE vrste pregleda
    getRazliciteVrstePregleda(){

        return this.http.get<any[]>(this.baseUrl + 'narucivanje/getRazliciteVrstePregleda.php').pipe(catchError(handleError));
    }
    ...
    otkaziNarudbu(idNarudzba: string){
        ...
        const params = new HttpParams().append("idNarudzba",idNarudzba);
        return this.http.delete<any>(this.baseUrl + 'narucivanje/otkaziNarudzbu.php',{params:params}).pipe(catchError(handleError));
    }
    ...
    dohvatiDatum(danUTjednu: string,datum: Date){
        ...
        return this.http.get<Date>(this.baseUrl + 'narucivanje/dohvatiDatum.php',{params: params}).pipe(catchError(handleError));
    }
    ...
    dohvatiVrijeme(vrijeme: Time){
        ...
        return this.http.get<Time>(this.baseUrl + 'narucivanje/dohvatiVrijeme.php',{params: params}).pipe(catchError(handleError));
    }
    ...
    dohvatiDanasnjiDatum(){
        ...
        return this.http.get<Date>(this.baseUrl + 'narucivanje/dohvatiDanasnjiDatum.php').pipe(catchError(handleError));
    }
    ...
    dohvatiNovoStanje(datum: Date){
        ...
        return this.http.get<any>(this.baseUrl + 'narucivanje/dohvatiNovoStanje.php',{params:params}).pipe(catchError(handleError));
    }
    ...
    dohvatiNovoStanjeDatumiNazivi(datum: Date){
        ...
        const params = new HttpParams().append("datum",datum.toString());
        return this.http.get<any>(this.baseUrl + 'narucivanje/dohvatiNovoStanjeDatumiNazivi.php',{params:params}).pipe(catchError(handleError));
    }
